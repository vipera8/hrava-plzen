...
function renderWebsite(){
 app.innerHTML = `<main class="web-page">
  ...
  <section id="o-hre" class="web-section"><div class="split"><div><h2>Dobrodružství v historickém srdci Plzně</h2><p>Na začátku znáte jen místo startu. Další cesta se vám otevře až během hry. Ideální volba, když chcete v Plzni zažít něco aktivního, chytrého a tajemného.</p></div><div class="info-card"><h3>Základní informace</h3><ul><li><b>Místo:</b> Plzeň</li><li><b>Start:</b> Hlavní vlakové nádraží, hlavní hala, u sochy Železničáře</li><li><b>Délka trasy:</b> cca 4–4,5 km</li><li><b>Doba hry:</b> cca 3–4 hodiny</li><li><b>Počet hráčů:</b> 2–5</li><li><b>Obtížnost:</b> začátečník až mírně pokročilý</li><li><b>Záloha na batoh:</b> 1 000 Kč vratná</li></ul></div></div><div class="section-divider-art"><img class="web-illustration" src="assets/images/web_mapa_plzne.jpg" alt="Stará mapa Plzně" loading="lazy"></div></section>
  ...
  <section id="rezervace" class="web-section split"><div><h2>Rezervujte si dobrodružství v Plzni</h2><p>Vyberte si termín a počet hráčů. Termín vám nejdříve potvrdíme e-mailem a poté pošleme platební údaje.</p><p>Rezervace je závazná po uhrazení celé ceny hry. Platba probíhá QR kódem nebo bankovním převodem. Batoh si převezmete na startu hry proti vratné záloze.</p><ul><li>rychlá rezervace přes formulář</li><li>termín potvrdíme před platbou</li><li>start v hlavní hale plzeňského nádraží</li></ul></div>${webForm('rezervace','Rezervace hry',['Jméno a příjmení','E-mail','Telefon','Požadovaný termín','Požadovaný čas','Počet dospělých','Počet dětí','Poznámka'],true,'Děkujeme za rezervaci. Termín ověříme a brzy vám pošleme potvrzení s platebními údaji.')}</section>
  <section id="poukazy" class="web-section split alt-bg"><div><h2>Darujte Plzeň jako dobrodružství</h2><p>Hledáte originální dárek, který neskončí v šuplíku? Darujte zážitek, při kterém se Plzeň promění v hru.</p><p>Dárkový poukaz na Grollovu zlatou stopu je vhodný pro páry, přátele, rodiny i všechny, kteří mají rádi zážitky, historii, šifry a trochu tajemství.</p><p>Poukaz vystavíme elektronicky s unikátním kódem. Platnost poukazu je 12 měsíců od zaplacení a obdarovaný si termín hry vybere později.</p><div class="section-divider-art voucher-art"><img class="web-illustration voucher-illustration" src="assets/images/web_darkovy_voucher_fade.png" alt="Dárkový voucher na hru Grollova zlatá stopa" loading="lazy"></div></div>${webForm('poukaz','Objednat dárkový poukaz',['Jméno objednatele','E-mail','Telefon','Počet osob','Poznámka'],false,'Děkujeme za objednávku poukazu. Brzy vám pošleme platební údaje.')}</section>
