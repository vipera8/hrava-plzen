...
function renderWebsite(){
 app.innerHTML = `<main class="web-page">
  ...
  <section id="o-hre" class="web-section"><div class="split"><div><h2>Dobrodružství v historickém srdci Plzně</h2><p>Na začátku znáte jen místo startu. Další cesta se vám otevře až během hry a přesná trasa zůstává součástí tajemství.</p><p>Hra je vhodná pro páry, přátele, rodiny i firemní týmy. Nemusíte být zkušení hráči únikových her — obtížnost je nastavená pro začátečníky až mírně pokročilé.</p><p>Ideální volba, když chcete v Plzni zažít něco aktivního, chytrého a trochu tajemného.</p></div><div class="info-card"><h3>Základní informace</h3><ul><li><b>Místo:</b> Plzeň</li><li><b>Start:</b> Hlavní vlakové nádraží, hlavní hala, u sochy Železničáře</li><li><b>Délka trasy:</b> cca 4–4,5 km</li><li><b>Doba hry:</b> cca 3–4 hodiny</li><li><b>Počet hráčů:</b> 2–5</li><li><b>Obtížnost:</b> začátečník až mírně pokročilý</li><li><b>Záloha na batoh:</b> 1 000 Kč vratná</li></ul></div></div><div class="section-divider-art"><img class="web-illustration" src="assets/images/web_mapa_plzne.jpg" alt="Stará mapa Plzně" loading="lazy"></div></section>
  <section class="web-section dark-band"><h2>Batoh plný tajemství. Město plné stop.</h2><p>Herní batoh je srdcem celého dobrodružství. Uvnitř najdete rekvizity, zámky, šifry a tematické předměty, které budete během cesty postupně využívat.</p><p>Některé věci vás navedou hned. Jiné vás možná budou mást, dokud nenastane správný okamžik. Právě díky tomu má hra atmosféru opravdové únikovky.</p><p class="hero-facts">Sáhnete si na příběh vlastníma rukama.</p><div class="section-divider-art"><img class="web-illustration" src="assets/images/web_klice.jpg" alt="Staré klíče jako součást herních rekvizit" loading="lazy"></div></section>
  ...
  <section id="cenik" class="web-section"><h2>Ceník hry</h2><p class="section-lead">Vyberte si velikost týmu a vydejte se po Grollově zlaté stopě.</p><div class="price-grid price-grid-two"><div><h3>2 hráči</h3><strong>1 400 Kč</strong></div><div><h3>3–5 hráčů</h3><strong>1 700 Kč</strong></div></div><p>Cena zahrnuje zapůjčení herního batohu s rekvizitami, přístup do herní webové aplikace a celý herní zážitek.</p><p class="note">Při převzetí batohu se skládá vratná záloha 1 000 Kč. Zálohu je možné složit v hotovosti nebo přes QR platbu. Po vrácení kompletního a nepoškozeného batohu bude záloha vrácena zpět, u QR platby zpravidla do 24 hodin.</p></section>
  <section id="rezervace" class="web-section split"><div><h2>Rezervujte si dobrodružství v Plzni</h2><p>Vyberte si termín a počet hráčů. Po odeslání rezervace vám pošleme platební údaje a po přijetí platby potvrdíme vše potřebné ke startu hry.</p><p>Platba probíhá QR kódem nebo bankovním převodem. Batoh si převezmete na startu hry proti vratné záloze.</p><ul><li>rychlá rezervace přes formulář</li><li>potvrzení po přijetí platby</li><li>start v hlavní hale plzeňského nádraží</li></ul></div>${webForm('rezervace','Rezervace hry',['Jméno a příjmení','E-mail','Telefon','Požadovaný termín','Požadovaný čas','Počet dospělých','Počet dětí','Poznámka'],true,'Děkujeme za rezervaci. Brzy vám pošleme platební údaje a po přijetí platby rezervaci potvrdíme.')}</section>
...
function renderTermsPage(){
 renderLegalShell('Obchodní a storno podmínky', `
  ...
  <div class="legal-block"><h2>4. Záloha na herní batoh</h2><p>Při převzetí herního batohu se skládá vratná záloha 1 000 Kč. Zálohu je možné složit v hotovosti nebo bezhotovostně přes QR platbu.</p><p>Záloha slouží jako jistota pro vrácení kompletního a nepoškozeného vybavení. Po vrácení batohu a všech součástí v pořádku bude záloha vrácena zákazníkovi. U zálohy složené přes QR platbu bude vrácení provedeno zpravidla do 24 hodin.</p><p>Pokud bude vybavení poškozeno, ztraceno nebo nevráceno, může být ze zálohy odečtena odpovídající náhrada škody.</p></div>
  ...
  <div class="legal-block"><h2>6. Dárkové poukazy</h2><p>Dárkový poukaz je možné vystavit elektronicky. Platnost poukazu je 12 měsíců od vystavení, pokud není na poukazu uvedeno jinak. Termín hry je nutné rezervovat předem.</p></div>
  ...
  <div class="legal-block"><h2>9. Reklamace a technická podpora</h2><p>Pokud během hry nastane technický problém, kontaktujte provozovatele telefonicky nebo přes SOS kontakt ve hře. Reklamaci je možné poslat e-mailem na <a href="mailto:hravaplzen@gmail.com">hravaplzen@gmail.com</a>. Reklamace bude vyřízena bez zbytečného odkladu.</p></div>
 `);
}
