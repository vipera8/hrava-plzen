...
function renderWebsite(){
 app.innerHTML = `<main class="web-page">
  ...
  <section id="poukazy" class="web-section split alt-bg"><div><h2>Darujte Plzeň jako dobrodružství</h2><p>Hledáte originální dárek, který neskončí v šuplíku? Darujte zážitek, při kterém se Plzeň promění v hru.</p><p>Dárkový poukaz na Grollovu zlatou stopu je vhodný pro páry, přátele, rodiny i všechny, kteří mají rádi zážitky, historii, šifry a trochu tajemství.</p><p>Poukaz je možné vystavit elektronicky. Na přání lze doplnit jméno obdarovaného a osobní věnování.</p><div class="section-divider-art voucher-art"><img class="web-illustration voucher-illustration" src="assets/images/web_darkovy_voucher.jpg" alt="Dárkový voucher na hru Grollova zlatá stopa" loading="lazy"></div></div>${webForm('poukaz','Objednat dárkový poukaz',['Jméno objednatele','E-mail','Telefon','Jméno obdarovaného','Počet osob','Věnování na poukaz','Elektronický / tištěný poukaz','Poznámka'],false,'Děkujeme za objednávku poukazu. Ozveme se vám s dalšími informacemi.')}</section>
