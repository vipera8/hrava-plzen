const CACHE='grollova-cesta-v111-menu-leaderboard-cache';
const STATIC=['./','./index.html','./404.html','./style.css','./app.js','./game-data.js','./manifest.webmanifest','./assets/images/certifikat-bez-titulu.jpg','./assets/images/groll_uvod.jpg','./assets/images/Groll_logo_na_sirku.jpg','./assets/images/Groll_logo_na_vysku.jpg','./assets/images/06_velka_synagoga_reseni_trojuhelniky.png'];
